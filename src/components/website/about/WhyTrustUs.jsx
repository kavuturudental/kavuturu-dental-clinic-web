      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-5 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <div className="flex justify-center">
            <AboutBadge>Why Patients Trust Us</AboutBadge>
          </div>
          ...
          >
            A Dental Experience Built on Trust, Technology & Compassion
          </h2>

          <p className="mt-6 text-lg leading-8 text-slate-600">
            From your first consultation to your final smile, every step of
            your journey is guided by experienced professionals, advanced
            technology, and a genuine commitment to your comfort and confidence.
          </p>
        </div>
