// src/receptionist/pages/Patients.jsx
...
import { Eye, Users, Phone, Mail, IdCard } from "lucide-react";
...
export default function Patients() {
  ...
  return (
    <DashboardLayout searchValue={searchQuery} onSearchChange={setSearchQuery}>
      <div className="p-1 space-y-2.5 max-w-[1600px] mx-auto font-sans select-none">
                      ...
                      <tr key={p._id || p.id || p.phone} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="py-5 px-6 text-right whitespace-nowrap">
                          <button
                            ...
                            className="px-4 py-1.5 rounded-full bg-[#0E2A6D] hover:bg-[#0a1f52] text-white font-bold text-xs transition-all cursor-pointer inline-flex items-center gap-1.5 shadow-2xs active:scale-98"
                          >
